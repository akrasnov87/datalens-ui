...
Fixed:
* Обновление версии 0.3498.1 -> 0.3498.2
* Увеличен лимит экспорта

## [0.3498.1] 04.03.2026

Fixed:

* Обновление версии 0.3498.0 -> 0.3498.1
* Исправлена ошибка при сохранении нового чарта

## [0.3498.0] 30.12.2025

Fixed:

* Обновление версии 0.3271.1 -> 0.3498.0

## [0.3271.1] 06.11.2025

Fixed:

* исправлена ошибка с назначением прав через "Связанные объекты";
* изменена стилизация окна авторизации.

## [0.3271.0] 03.10.2025

Fixed:

* Обновление версии 0.3168.0 -> 0.3271.0
...
- добавлена переменная `UNITED_STORAGE_CONFIG_LOADED_TIMEOUT` - таймаут на получение информации о связи двух таблиц по связанному ключу, по умолчанию значение 10000 ms
...
- исправлен интерфейс "Поделиться", добавлена кнопка "Обновить ссылку".
